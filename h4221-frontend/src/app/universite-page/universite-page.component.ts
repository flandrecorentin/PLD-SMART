...
export class UniversitePageComponent implements OnInit, OnDestroy {
  ...
  TransportReservationDateMeanString = "";
  AccomodationReservationDateMeanString = "";
  AccomodationReservationDateMean = 0;
  OlaDateMeanString = "";
  OlaDateMean = 0;
  ERASMUSFirstContactDateMeanString = "";
  ERASMUSFirstContactDateMean = 0;
  BRMIEApplicationDeadlineMeanString = "";
  BRMIEApplicationDeadlineMean = 0;
  BRMIEFirstContactDateMeanString = "";
  BRMIEFirstContactDateMean = 0;
  AMIApplicationDeadlineMeanString = "";
  AMIApplicationDeadlineMean = 0;
  AMIFirstContactDateMeanString = "";
  ...
  async envoiMessage(texte: string) {
    const conversationId = this.displayedChat.stringId
    const author = localStorage.getItem("mail")
    const date = new Date();
  ...
  async creerConv(name: string) {
    const creator = localStorage.getItem("mail")
    const date = new Date();
    const dateFormat = date.toDateString()
